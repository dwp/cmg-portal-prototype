...
const caseData = {
  ...
  janet: {
    ...
    messages: {
      msg0: ["We need to check some information with you", "01/02/2021"],
      msg1: ["janet message 2", "28/12/2020"],
      msg2: ["janet message 3", "19/12/2020"],
    },
    changes: {
      chng0: ["janet change 1", "yellow", "in progress"],
      chng1: ["janet change 2", "yellow", "in progress"],
      chng2: ["janet change 3", "green", "completed"],
    },
  },
  clive: {
    case: "clive",
    messages: {
      ...
      msg1: ["clive message 2", "11/11/2020"],
      msg2: ["clive message 3", "11/11/2020"],
    },
    changes: {
      chng0: ["Change to Direct Pay or Collect and Pay", "green", "completed"],
      chng1: ["Change phone number", "green", "completed"],
      chng2: ["Change address", "green", "completed"],
    },
  },
  frankie: {
    case: "frankie",
    messages: {
      msg0: ["We've worked out your child maintenance payments", "01/02/2021"],
      msg1: ["frankie message 2", "15/01/2021"],
      msg2: ["frankie message 3", "31/12/2020"],
    },
    changes: {
      chng0: ["Update shared care", "green","received"],
      chng1: ["frankie change 2", "green", "received"],
      chng2: ["frankie change 3", "yellow", "in progress"],
    },
  },
};
